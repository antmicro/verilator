...
// Total: 100 solutions
// Expecting uniform distribution, each solution being ~1%. Both groups should be equally represented (~50% / ~50%)
// This should reveal whether the space is being explored simmetrically
// write constant num iterations
