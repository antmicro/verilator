// Array-scaling benchmark: genuinely two-dimensional array (new dimension
// axis vs. distr_array_basic/sum/mixed, which are all 1D) -- exercises the
// multi-dimensional flat-index bookkeeping (m_indices/m_idxWidths) that
// collapses arr[i][j] down to one flattened SMT variable per leaf element.
//
// Variables:
...
// Solutions: 3^8 = 6561
//
// Canonical output order: (arr[0][0],arr[0][1],...,arr[1][3]) row-major,
