// Array-scaling benchmark: 2D array (matrix) with a full-sum constraint
// across ALL elements -- combines the "2D shape" axis (distr_array_2d_range)
// with the "sum coupling" axis (distr_array_sum/wide_sum), a combination
// not otherwise in this suite.
//
// Variables:
...
// Solutions: 246
//
// Canonical output order: (arr[0][0],arr[0][1],arr[1][0],arr[1][1])
