// Array-isolation benchmark: cross-element aggregate constraint over an
// array (sum), a different constraint *shape* than the independent-range
// (distr_array_basic) or distinctness (distr_array_unique) cases.
//
// Variables:
...
//
// Canonical output order: (arr[0],arr[1],arr[2]) lexicographic ascending
