// Array-scaling benchmark: fewer elements than distr_array_many_elem, but
// each one wider (4 bits vs. 3) and tied together by a cross-element sum --
// stresses the "lots of bits per element" axis together with a genuinely
// combinatorial (not just per-element-independent) constraint shape.
//
// Variables:
