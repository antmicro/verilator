// Real-world benchmark extracted from OpenTitan aes_message_item.sv
// Source: hw/ip/aes/dv/env/aes_message_item.sv (keylen_c, mode_c, rsd_rate_c, operation_c)
//         hw/ip/aes/rtl/aes_pkg.sv (encoding constants)
//
// Models the AES configuration error-injection pattern:
//   A single 'has_error' flag toggles all four config fields between
//   their valid one-hot encodings and their illegal complements.
//
// Variables:
...
//
// Canonical output order: sorted by (has_error, op, key_len, mode, reseed_rate)
// Output format: "%0d %0d %0d %0d %0d" has_error op key_len mode reseed_rate
