// Sparse benchmark: all perfect squares in the 16-bit domain.
// Dimension 3 (solution space shape): sparse/tight.
// 256 solutions scattered across 65536 possible values — density 0.39%.
// Gaps between solutions grow quadratically: near 0 they are dense
// (0,1,4,9,...), near 65535 they are wide (e.g. 64009,64516,65025).
//
// Variables:
//   x : bit [15:0] -- 16-bit unsigned, domain [0:65535]
//
// Constraint:
//   x inside {0, 1, 4, 9, 16, ..., 65025}  (all perfect squares n² for n in [0:255])
//
// Solutions: 256 (n=0..255, n²<=65535)
// Domain size: 65536 -- density: 256/65536 = 0.39%
//
