// Unequal bins benchmark: if/else selects between two ranges of very different sizes.
// Inspired by OpenTitan aon_timer_base_vseq: aim_bite selects between bark/bite
// threshold branches. Adapted to make the two branches explicitly asymmetric.
//
// Variables:
...
//
// Canonical output order: (mode, x) lexicographic ascending
