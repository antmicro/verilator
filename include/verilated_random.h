...
class VlRandomizer VL_NOT_FINAL {
    ...
    bool m_ug2PrevHashValid = false;  // Whether m_ug2PrevHash has been set yet
    bool m_ug2HasLastSuccess = false;  // Whether m_ug2LastSuccessI is set
    int m_ug2LastSuccessI = 0;  // Hash-bit count that worked last time, retried first
