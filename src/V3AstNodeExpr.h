...
class AstSConsRep final : public AstNodeExpr {
    // Consecutive repetition [*N], [*N:M], [*1:$], [+], [*] (IEEE 1800-2023 16.9.2)
    ...
    //   [+] / [*1:$]: countp=1, maxCountp=nullptr,  unbounded=true
    ...
    const bool m_unbounded = false;  // True for [+], [*] and [*1:$] (upper bound is $)
public:
    // Exact [*N]
