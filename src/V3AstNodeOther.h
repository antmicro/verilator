...
class AstNodeFTask VL_NOT_FINAL : public AstNode {
    ...
    std::vector<AstVarRef*>
        m_impliciteScopeAccessRefs;  // Refs that implicitly accesses outer scope, e.g. from task
                                     // that is inside class declared in module
...
public:
    ...
    void addImpliciteScopeAccessRef(AstVarRef* ref) { m_impliciteScopeAccessRefs.push_back(ref); }
    const std::vector<AstVarRef*>& impliciteScopeAccessRefs() const {
        return m_impliciteScopeAccessRefs;
    }
    void clearImpliciteScopeAccessRefs() { m_impliciteScopeAccessRefs.clear(); }
