...
class DelayedVisitor final : public VNVisitor {
    ...
    VDouble0 m_nonInlinedCAwaitsWithSenTreep;  // Count uses of not inlined co_awaits
    ...
    void addCFuncCachedValues(const AstCFunc* const cfuncp,
        ...
        m_nonInlinedCAwaitsWithSenTreep += value.m_timingDomains.size();
    ...
    // this way. Also, not visiting such AstCFuncs allows to avaid caching results for them which
...
public:
    ...
    ~DelayedVisitor() override {
        ...
        V3Stats::addStat("Count of non-inlined co_awaits with SenTree",
                         m_nonInlinedCAwaitsWithSenTreep);
    }
};
