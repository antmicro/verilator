...
class DynamicSchedulerMarkDynamicVisitor final : public VNVisitor {
private:
    // TYPES
    struct Overrides {
...
class DynamicSchedulerCreateEventsVisitor final : public VNVisitor {
private:
    // STATE
...
class DynamicSchedulerAddTriggersVisitor final : public VNVisitor {
private:
    // NODE STATE
