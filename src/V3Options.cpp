...
void V3Options::parseOptsList(FileLine* fl, const string& optdir, int argc,
    ...
    DECL_OPTION("-force-hierarchical", FOnOff, &m_forceHierarchical);
    ...
    DECL_OPTION("-hierarchical-type-parameter-file", CbVal,
                [this](const char* optp) { m_hierarchicalTypeParameterFile = optp; });
