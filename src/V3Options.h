...
private:
    ...
    string m_hierarchicalTypeParameterFile; // main switch: --hierarchical-type-parapeter-file
...
public:
    ...
    string hierarchicalTypeParameterFile() const { return m_hierarchicalTypeParameterFile; }
