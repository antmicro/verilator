...
file_grep($secret_dir . "/Vsub0_/sub0_.sv", /^module\s+(\S+)\s+/, "sub0");
file_grep($secret_dir . "/Vsub1_/sub1_.sv", /^module\s+(\S+)\s+/, "sub1");
file_grep($secret_dir . "/Vsub2_/sub2_.sv", /^module\s+(\S+)\s+/, "sub2");
